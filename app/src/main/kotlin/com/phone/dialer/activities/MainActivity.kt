...
import com.phon.dialer.BuildConfig
import com.phon.dialer.R
import com.phon.dialer.adapters.ViewPagerAdapter
import com.phon.dialer.databinding.ActivityMainBinding
import com.phon.dialer.dialogs.ChangeSortingDialog
import com.phon.dialer.dialogs.FilterContactSourcesDialog
import com.phon.dialer.extensions.config
import com.phon.dialer.extensions.launchCreateNewContactIntent
import com.phon.dialer.fragments.ContactsFragment
import com.phon.dialer.fragments.FavoritesFragment
import com.phon.dialer.fragments.MyViewPagerFragment
import com.phon.dialer.fragments.RecentsFragment
import com.phon.dialer.helpers.*
...
class MainActivity : SimpleActivity() {
    ...
    private fun getSelectedTabDrawableIds(): List<Int> {
        ...
        if (showTabs and TAB_DIALPAD != 0) {
            icons.add(R.drawable.shortcut_dialpad)
        }
